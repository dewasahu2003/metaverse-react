...
const Feedback = () => (
  <section className={`${styles.paddings} relative z-10`} >
    <motion.div variants={staggerContainer}
      ...
      viewport={{ once: false, amount: 0.25 }} className={`${styles.innerWidth} mx-auto flex lg:flex-row flex-col gap-6`}>
      <motion.div variants={fadeIn('right', 'tween', 0.2, 1)} className='flex-[0.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative'>
        ...
        <div>
          <h4 className='font-bold sm:text-[32px] text-[26px] sm:leading-[40px] leading-[36px] text-white'>Dewa</h4>
          <p className='mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white'>Founder |Metaverse</p>
        </div>

        <p className='mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[40px] leading-[16px] text-white'>
      ...
      <motion.div variants={fadeIn('left', 'tween', 0.2, 1)} className='relative flex-1 flex justify-center items-center'>
        ...
        <motion.div variants={zoomIn(0.2, 1)} className='lg:block hidden absolute left-[-15%] top-[3%]'>
          <img src="/stamp.png" alt="stamp" className='w-[160px] h-[160px] object-contain' />
